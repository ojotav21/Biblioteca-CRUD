...
?>
                                                    <td>
                                                    <a href="form_atualiza_aluno.php?ra=<?php echo $linha['ra'];?>" class="fa fa-pencil-square-o" aria-hidden="true" style="border-radius: 30px; color: blue;">Atualizar</a> <!-- -->
                                                    &nbsp; &nbsp;  
                                                    <a href="delete_aluno.php?ra=<?php echo $linha['ra'];?>" class="fa fa-trash" aria-hidden="true" style="border-radius: 30px; color: red;">Deletar</a>
                                                    </td> 
