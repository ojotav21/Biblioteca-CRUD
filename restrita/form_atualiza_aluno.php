                    ...
                    <form action="atualiza_aluno.php?ra=<?php echo $ra; ?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                ...
                                class="form-control">      <!-- value vai receber o campo do banco de dados.
                            vetor $linha[ra] -->
                            </div>
                        </div>
                        <div class="row form-group">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="text-input" name="celular" value ="<?php    echo $linha['telcel'];?>"  class="form-control">
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col col-md-3">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="date" id="text-input" name="nascimento" value ="<?php    echo $linha['dataNasc'];?>"  class="form-control">
                            </div>
                        </div>
